  ...
  return (
    <div className="min-h-screen bg-[#F4F1EC]">
            ...
            <div className="flex flex-wrap gap-x-4 gap-y-2 mt-6 animate-fade-in-up animation-delay-400">
              {["Locally Owned & Operated", "Free Estimates", "Residential & Commercial", "Satisfaction Guaranteed"].map((item) => (
                <div key={item} className="flex items-center gap-1.5 text-white/70 text-xs sm:text-sm font-ui">
                  <CheckCircle size={13} className="text-[#E85D04] flex-shrink-0" />
                  {item}
                </div>
              ))}
            </div>
      ...
      {/* ============================================================
          SERVICES SECTION
          ============================================================ */}
      <section className="py-16 sm:py-20 lg:py-28 bg-[#F4F1EC]">
        <div className="container">
          <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-4 mb-10 sm:mb-14">
            <div>
              ...
              <h2 className="font-display font-black text-[clamp(2.5rem,8vw,4rem)] text-[#1A1A1A] uppercase leading-none">
                Full-Service<br />
                <span className="text-[#E85D04]">Exterior</span><br />
                Solutions
              </h2>
            </div>
            <p className="font-body text-[#1A1A1A]/70 max-w-md text-base sm:text-lg lg:text-right">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4">
            {SERVICES.map((service, i) => (
              <Link
                ...
                className="group relative bg-white border border-[#1A1A1A]/10 p-5 sm:p-6 hover:border-[#E85D04] hover:shadow-xl transition-all duration-300 active:scale-[0.99]"
                style={{ transitionDelay: `${i * 40}ms` }}
              >
                <div className="text-3xl mb-3">{service.icon}</div>
                <h3 className="font-display font-bold text-lg sm:text-xl text-[#1A1A1A] uppercase tracking-wide mb-2 group-hover:text-[#E85D04] transition-colors">
                  {service.name}
                </h3>
      ...
      {/* ============================================================
          ...
          ============================================================ */}
      <section className="py-16 sm:py-20 lg:py-28 bg-[#1A1A1A] grain-overlay overflow-hidden">
        <div className="container">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-20 items-center">
            ...
            <div className="relative">
              <div className="relative">
                ...
                />
                <div className="absolute -bottom-3 -right-3 sm:-bottom-4 sm:-right-4 bg-[#E85D04] p-4 sm:p-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
            {TESTIMONIALS.map((testimonial, i) => (
              <div
                ...
                className="bg-white border border-[#1A1A1A]/10 p-5 sm:p-6"
                itemScope
              ...
              >
                ...
                <div className="flex gap-1 mb-4">
                  {Array.from({ length: testimonial.rating }).map((_, j) => (
                    <Star key={j} size={15} className="text-[#E85D04] fill-[#E85D04]" />
                  ))}
                </div>
                <blockquote className="font-body text-[#1A1A1A]/80 text-sm leading-relaxed mb-5" itemProp="reviewBody">
                  "{testimonial.text}"
                </blockquote>
                <div className="flex items-start justify-between gap-2 border-t border-[#1A1A1A]/10 pt-4">
                  <div className="min-w-0">
                    <div className="font-display font-bold text-sm text-[#1A1A1A] uppercase tracking-wide truncate" itemProp="author">
                      {testimonial.name}
                    </div>
                  ...
                  <span className="text-xs font-ui text-[#E85D04] font-semibold uppercase tracking-wider bg-[#E85D04]/10 px-2 py-1 rounded-sm flex-shrink-0 text-right leading-tight">
                    {testimonial.service}
                  </span>
                </div>
              </div>
      ...
      <section className="bg-white overflow-hidden">
        <div className="grid grid-cols-1 lg:grid-cols-2">
          ...
          <div className="bg-[#1A1A1A] p-8 sm:p-10 lg:p-16 flex flex-col justify-center">
      ...
      <section className="py-16 sm:py-20 lg:py-28 bg-[#F4F1EC]">
        <div className="container">
          <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-4 mb-10 sm:mb-12">
            ...
            <p className="font-body text-[#1A1A1A]/70 max-w-md text-base sm:text-lg">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-2 sm:gap-3">
            {SERVICE_AREAS.map((area) => (
              <Link
                ...
                className="group bg-white border border-[#1A1A1A]/10 p-4 sm:p-5 hover:border-[#E85D04] hover:bg-[#E85D04] transition-all duration-200 active:scale-[0.98]"
              >
                <div className="flex items-center gap-2 mb-1">
                  <MapPin size={13} className="text-[#E85D04] group-hover:text-white transition-colors flex-shrink-0" />
                  <span className="font-display font-bold text-sm sm:text-base text-[#1A1A1A] group-hover:text-white uppercase tracking-wide transition-colors leading-tight">
                    {area.city}
                  </span>
                </div>
          ...
          <div className="max-w-3xl mx-auto">
            ...
            <div className="space-y-3" itemScope itemType="https://schema.org/FAQPage">
              {[
                ...
                <details
                  key={i}
                  className="group bg-[#F4F1EC] border border-[#1A1A1A]/10"
                  itemScope
                  itemProp="mainEntity"
                  itemType="https://schema.org/Question"
                >
                  <summary className="flex items-center justify-between p-4 sm:p-5 cursor-pointer list-none gap-3">
                    <h3 className="font-display font-bold text-base sm:text-lg text-[#1A1A1A] uppercase tracking-wide" itemProp="name">
                      {faq.q}
                    </h3>
                  ...
                  <div className="px-4 sm:px-5 pb-4 sm:pb-5" itemScope itemProp="acceptedAnswer" itemType="https://schema.org/Answer">
                    <p className="font-body text-[#1A1A1A]/70 leading-relaxed text-sm sm:text-base" itemProp="text">
                      {faq.a}
                    </p>
                  </div>
                </details>
      ...
      {/* ============================================================
          ABOUT / TEAM SECTION
          ============================================================ */}
      <section className="py-16 sm:py-20 lg:py-28 bg-[#F4F1EC] overflow-hidden">
        <div className="container">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-20 items-center">
            <div>
              <span className="section-label">About Us</span>
              <span className="accent-rule my-3"></span>
              <h2 className="font-display font-black text-[clamp(2.5rem,8vw,4rem)] text-[#1A1A1A] uppercase leading-none mb-5">
                Your Neighbors.<br />
            ...
            <div className="relative">
              ...
              />
              <div className="absolute -bottom-3 -left-3 sm:-bottom-4 sm:-left-4 bg-[#1A1A1A] p-4 sm:p-5">
                <div className="font-display font-black text-[#E85D04] text-2xl sm:text-3xl">Locally</div>
      ...
      {/* ============================================================
          FINAL CTA SECTION
          ============================================================ */}
      <section className="py-16 sm:py-20 bg-[#1A1A1A] grain-overlay">
