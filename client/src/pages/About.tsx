...
export default function About() {
  ...
  return (
    <div className="min-h-screen bg-[#F4F1EC]">
        ...
        <div className="container">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-20 items-center">
            <div>
              ...
              <span className="accent-rule my-3"></span>
              <h2 className="font-display font-black text-[clamp(2rem,7vw,3.5rem)] text-[#1A1A1A] uppercase leading-none mb-5">
        ...
        <div className="container">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
            {[
              ...
              <div key={value.title} className="bg-white/5 border border-white/10 p-5 sm:p-6 hover:border-[#E85D04] transition-colors">
      ...
      {/* Why Choose Us */}
      <section className="py-14 sm:py-20 bg-[#F4F1EC]">
        <div className="container">
          <div className="max-w-3xl mx-auto">
            ...
            <div className="space-y-3 sm:space-y-4">
              {[
                ...
                <div key={item.title} className="flex gap-3 sm:gap-4 bg-white border border-[#1A1A1A]/10 p-4 sm:p-5">
                  <CheckCircle size={18} className="text-[#E85D04] flex-shrink-0 mt-0.5" />
                  <div>
                    <h3 className="font-display font-bold text-sm sm:text-base text-[#1A1A1A] uppercase tracking-wide mb-1">{item.title}</h3>
      ...
      {/* CTA */}
      <section className="py-14 sm:py-16 bg-[#E85D04]">
        <div className="container text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center">
            <a href={PHONE_HREF} className="flex items-center justify-center gap-2 bg-white text-[#E85D04] font-display font-black text-lg sm:text-xl uppercase tracking-wider px-6 sm:px-8 py-3 sm:py-4 rounded-sm hover:bg-[#1A1A1A] hover:text-white transition-all">
              <Phone size={20} />
              {PHONE}
            </a>
            <Link href="/contact" className="flex items-center justify-center gap-2 bg-transparent border-2 border-white text-white font-display font-black text-lg sm:text-xl uppercase tracking-wider px-6 sm:px-8 py-3 sm:py-4 rounded-sm hover:bg-white hover:text-[#E85D04] transition-all">
