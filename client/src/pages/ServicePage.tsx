        ...
        <div className="container">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-10 lg:gap-12">
            ...
            <div className="lg:col-span-2">
              ...
              <p className="font-body text-[#1A1A1A]/70 leading-relaxed text-base sm:text-lg mb-8">
                {service.longDescription}
              </p>

              {/* Benefits */}
              <h3 className="font-display font-bold text-xl sm:text-2xl text-[#1A1A1A] uppercase tracking-wide mb-4">
                Key Benefits
              </h3>
              <ul className="grid grid-cols-1 sm:grid-cols-2 gap-2 sm:gap-3 mb-8 sm:mb-10">
                {service.benefits.map((benefit) => (
                  <li key={benefit} className="flex items-start gap-3 bg-white border border-[#1A1A1A]/10 p-3 sm:p-4">
                    <CheckCircle size={17} className="text-[#E85D04] flex-shrink-0 mt-0.5" />
              ...
              {/* Process */}
              <h3 className="font-display font-bold text-xl sm:text-2xl text-[#1A1A1A] uppercase tracking-wide mb-5">
                Our Process
              </h3>
              <div className="space-y-3 mb-8 sm:mb-10">
                {service.process.map((step, i) => (
                  <div key={step.step} className="flex gap-3 sm:gap-4 bg-white border border-[#1A1A1A]/10 p-4 sm:p-5">
                    <div className="w-9 h-9 sm:w-10 sm:h-10 bg-[#E85D04] rounded-sm flex items-center justify-center flex-shrink-0">
                      <span className="font-display font-black text-white text-base sm:text-lg">{i + 1}</span>
                    </div>
                    <div>
                      <h4 className="font-display font-bold text-base sm:text-lg text-[#1A1A1A] uppercase tracking-wide mb-1">
                        {step.step}
                      </h4>
                ...
                {service.faqs.map((faq, i) => (
                  ...
                  >
                    <summary className="flex items-center justify-between p-4 sm:p-5 cursor-pointer list-none gap-3">
                      <h4 className="font-display font-bold text-sm sm:text-base text-[#1A1A1A] uppercase tracking-wide" itemProp="name">
                        {faq.question}
                      </h4>
